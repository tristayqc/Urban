...
{
    [Tooltip("This field sets a gameobject that tracks the pose of your tracker")]
    public Transform teleportPointer;           // Teleport pointer: a gameobject that tracks the pose of your tracker
